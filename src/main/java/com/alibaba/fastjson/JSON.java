...
/**
 * This is the main class for using Fastjson. You usually call these two methods
 * {@link #toJSONString(Object)} and {@link #parseObject(String, Class)}.
 * 
 * <p>
 ...
 * be an array) then you must use the {@link #toJSONString(Object)} or
 * {@link #parseObject(String, Type, Feature[])} method. Here is an example for
 * serializing and deserialing a {@code ParameterizedType}:
 * 
 * <pre>
 * String json = "[{},...]";
 * Type listType = new TypeReference&lt;List&lt;Model&gt;&gt;() {
 * }.getType();
...
public abstract class JSON implements JSONStreamAware, JSONAware {
	 ...
	 * type, invoke {@link #parseObject(String, Type, Feature[])}. If you have the
	 * Json in a {@link InputStream} instead of a String, use
	 * {@link #parseObject(InputStream, Type, Feature[])} instead.
	 *
	 ...
	 * non-generic objects, use {@link #parseObject(String, Class, Feature[])}
	 * instead. If you have the Json in a {@link InputStream} instead of a String,
	 * use {@link #parseObject(InputStream, Type, Feature[])} instead.
	 *
	 * @param <T>  the type of the desired object
	 * @param json the string from which the object is to be deserialized
	 * @param type The specific genericized type of src. You can obtain this type by
	 *             using the {@link com.alibaba.fastjson.TypeReference} class. For
	 *             example, to get the type for {@code Collection<Foo>}, you should
	 *             use:
	 * 
	 *             <pre>
	 *             Type type = new TypeReference&lt;Collection&lt;Foo&gt;&gt;() {
	 *             }.getType();
	 *             </pre>
	 * 
	 ...
	 * representation. Note that this method works fine if the any of the object
	 * fields are of generic type, just the object itself should not be of a generic
	 * type. If you want to write out the object to a {@link Writer}, use
	 * {@link #writeJSONString(Writer, Object, SerializerFeature[])} instead.
	 *
	 * @param object the object for which json representation is to be created
	 *               setting for fastjson
	...
	public static String toJSONStringWithDateFormat(Object object, String dateFormat,
		...
		return toJSONString(object, SerializeConfig.globalInstance, null, dateFormat, DEFAULT_GENERATE_FEATURE,
				features);
	}
	 ...
	 * representation as a tree of {@link JSONObject}s.
	 *
	 */
